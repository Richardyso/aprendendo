...
while True:
    ...
    if selected_object:
        ...
        if keys[pygame.K_LEFT]:
            if selected_object[0] == "square":
                new_pos = (max(square_pos[selected_object[1]][0] - velocidade, 0), square_pos[selected_object[1]][1])
                collision = False
                for i, pos in enumerate(retangulos_pos):
                ...
                new_pos = (max(retangulos_pos[selected_object[1]][0] - velocidade, 0), retangulos_pos[selected_object[1]][1])
                collision = False
                for i, pos in enumerate(square_pos):
                ...
                new_pos = (max(horizontal_rect_pos[0] - velocidade, 0), horizontal_rect_pos[1])
                collision = False
            ...
            if selected_object[0] == "square":
                new_pos = (min(square_pos[selected_object[1]][0] + velocidade, LARGURA - square_size), square_pos[selected_object[1]][1])
                collision = False
                for i, pos in enumerate(retangulos_pos):
                    if check_collision((new_pos[0], new_pos[1], square_size, square_size), (pos[0], pos[1], retangulo_width, retangulo_height)):
                        collision = True
                ...
                new_pos = (min(retangulos_pos[selected_object[1]][0] + velocidade, LARGURA - retangulo_width), retangulos_pos[selected_object[1]][1])
                collision = False
                for i, pos in enumerate(square_pos):
                    if check_collision((new_pos[0], new_pos[1], retangulo_width, retangulo_height), (pos[0], pos[1], square_size, square_size)):
                        collision = True
                ...
                new_pos = (min(horizontal_rect_pos[0] + velocidade, LARGURA - horizontal_rect_width), horizontal_rect_pos[1])
                collision = False
                for pos in square_pos:
                    if check_collision((new_pos[0], new_pos[1], horizontal_rect_width, horizontal_rect_height), (pos[0], pos[1], square_size, square_size)):
                        collision = True
            ...
            if selected_object[0] == "square":
                new_pos = (square_pos[selected_object[1]][0], max(square_pos[selected_object[1]][1] - velocidade, 0))
                collision = False
                for i, pos in enumerate(retangulos_pos):
                    if check_collision((new_pos[0], new_pos[1], square_size, square_size), (pos[0], pos[1], retangulo_width, retangulo_height)):
                        collision = True
                ...
                new_pos = (retangulos_pos[selected_object[1]][0], max(retangulos_pos[selected_object[1]][1] - velocidade, 0))
                collision = False
                for i, pos in enumerate(square_pos):
                    if check_collision((new_pos[0], new_pos[1], retangulo_width, retangulo_height), (pos[0], pos[1], square_size, square_size)):
                        collision = True
                ...
                new_pos = (horizontal_rect_pos[0], max(horizontal_rect_pos[1] - velocidade, 0))
                collision = False
                for pos in square_pos:
                    if check_collision((new_pos[0], new_pos[1], horizontal_rect_width, horizontal_rect_height), (pos[0], pos[1], square_size, square_size)):
                        collision = True
            ...
            if selected_object[0] == "square":
                new_pos = (square_pos[selected_object[1]][0], min(square_pos[selected_object[1]][1] + velocidade, ALTURA - square_size))
                collision = False
                for i, pos in enumerate(retangulos_pos):
                    if check_collision((new_pos[0], new_pos[1], square_size, square_size), (pos[0], pos[1], retangulo_width, retangulo_height)):
                        collision = True
                ...
                new_pos = (retangulos_pos[selected_object[1]][0], min(retangulos_pos[selected_object[1]][1] + velocidade, ALTURA - retangulo_height))
                collision = False
                for i, pos in enumerate(square_pos):
                    if check_collision((new_pos[0], new_pos[1], retangulo_width, retangulo_height), (pos[0], pos[1], square_size, square_size)):
                        collision = True
                ...
                new_pos = (horizontal_rect_pos[0], min(horizontal_rect_pos[1] + velocidade, ALTURA - horizontal_rect_height))
                collision = False
                for pos in square_pos:
                    if check_collision((new_pos[0], new_pos[1], horizontal_rect_width, horizontal_rect_height), (pos[0], pos[1], square_size, square_size)):
                        collision = True
    ...
    # Desenho dos objetos
    for pos in square_pos:
        pygame.draw.rect(screen, VERMELHO, (pos[0], pos[1], square_size, square_size))
    for pos in retangulos_pos:
        pygame.draw.rect(screen, VERDE, (pos[0], pos[1], retangulo_width, retangulo_height))
    pygame.draw.rect(screen, AZUL, (horizontal_rect_pos[0], horizontal_rect_pos[1], horizontal_rect_width, horizontal_rect_height))
